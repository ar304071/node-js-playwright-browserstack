...
const caps = {
  ...
  'browserstack.username': process.env.BROWSERSTACK_USERNAME || 'tonytiger_iogGbU',
  'browserstack.accessKey': process.env.BROWSERSTACK_ACCESS_KEY || 'FXLbi8VRUQuX4xHvbUwX',
